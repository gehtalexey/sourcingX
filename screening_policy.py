...
- When it is truly ambiguous and there is no company-size data either way, lean toward MET rather than rejecting a possibly-strong candidate on a data gap. Do NOT fabricate startup status — this is about not defaulting to reject on absent data, not inventing facts.
