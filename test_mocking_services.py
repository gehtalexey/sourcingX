...
- Mock OpenAI API calls without hitting the real API
...
class TestOpenAIMocking:
    ...
    def test_screen_profile_uses_correct_model(self, mock_openai_client,
        ...
        """Test that screen_profile uses the correct OpenAI model."""
        import dashboard
    ...
    def test_screen_profile_uses_json_response_format(self, mock_openai_client,
                                                       strong_backend_profile,
                                                       backend_job_description):
        """Test that screen_profile requests JSON response format."""
        import dashboard
        dashboard.screen_profile(strong_backend_profile, backend_job_description,
                                  mock_openai_client)
    ...
    def test_screen_profile_uses_low_temperature(self, mock_openai_client,
                                                  strong_backend_profile,
                                                  backend_job_description):
        """Test that screen_profile uses low temperature for consistency."""
        import dashboard
        dashboard.screen_profile(strong_backend_profile, backend_job_description,
                                  mock_openai_client)
    ...
    def test_screen_profile_includes_system_prompt(self, mock_openai_client,
                                                    strong_backend_profile,
                                                    backend_job_description):
        """Test that screen_profile includes a system prompt."""
        import dashboard
        dashboard.screen_profile(strong_backend_profile, backend_job_description,
                                  mock_openai_client)
    ...
    def test_custom_system_prompt_is_used(self, mock_openai_client,
                                           strong_backend_profile,
                                           backend_job_description):
        """Test that custom system prompts are properly passed."""
        import dashboard
...
class TestErrorHandling:
    ...
    def test_empty_profile_returns_skipped(self, mock_openai_client, empty_profile,
                                            backend_job_description):
        """Test that empty profiles are skipped without calling API."""
        import dashboard
    ...
    def test_profile_without_work_history_returns_missing_data(self, mock_openai_client,
                                                                backend_job_description):
        """Test that profiles without work history are flagged."""
        import dashboard
        profile = {
            'first_name': 'Test',
            'last_name': 'User',
...
# =============================================================================
# TESTS: Batch Screening with Mocking
# =============================================================================
...
class TestBatchScreeningMocking:
    ...
    def test_batch_screening_processes_all_profiles(self, strong_backend_profile,
                                                     ...
                                                     backend_job_description):
        """Test that batch screening processes all profiles."""
        import dashboard
    ...
    def test_batch_screening_handles_cancellation(self, strong_backend_profile,
                                                   backend_job_description):
        """Test that batch screening respects cancellation flag."""
        import dashboard
    ...
    def test_batch_screening_calls_progress_callback(self, strong_backend_profile,
                                                      backend_job_description):
        """Test that batch screening calls progress callback."""
        import dashboard
...
class TestHelperFunctionMocking:
    ...
    def test_format_past_positions_is_called(self, mock_openai_client,
                                              strong_backend_profile,
                                              backend_job_description):
        """Test that format_past_positions is used during screening."""
        import dashboard
    ...
    def test_format_education_is_called(self, mock_openai_client,
                                         strong_backend_profile,
                                         backend_job_description):
        """Test that format_education is used during screening."""
        import dashboard
...
class TestUsageTrackerMocking:
    ...
    def test_usage_tracker_records_tokens(self, mock_openai_client,
                                           strong_backend_profile,
                                           backend_job_description):
        """Test that usage tracker is called with token counts."""
        import dashboard
...
class TestConcurrencyMocking:
    ...
    def test_batch_screening_thread_safety(self, strong_backend_profile,
                                            backend_job_description):
        """Test that batch screening handles concurrent access safely."""
        import dashboard
...
class TestAPIResponseVariations:
    ...
    def test_handles_response_without_why_field(self, mock_openai_client_factory,
                                                  strong_backend_profile,
                                                  backend_job_description):
        """Test handling responses that don't include 'why' field."""
    ...
    def test_handles_response_with_extra_fields(self, mock_openai_client_factory,
                                                  strong_backend_profile,
                                                  backend_job_description):
        """Test handling responses with unexpected extra fields."""
        mock_client = mock_openai_client_factory({
