...
Tests cover:
- Profile scoring based on company quality
- Rejection rules (overqualified, consulting, job hopper)
...
# =============================================================================
# PARAMETERIZED TESTS: format_past_positions
# =============================================================================
...
class TestFormatPastPositions:
    ...
    def test_format_positions_contains_expected(self, positions, expected_contains):
        """Test that formatted positions contain expected strings."""
    ...
    def test_format_positions_handles_empty(self, positions):
        """Test that empty/invalid positions don't cause errors."""
        result = format_past_positions(positions or [])
        assert isinstance(result, str)


# =============================================================================
# PARAMETERIZED TESTS: format_education
# =============================================================================
...
class TestFormatEducation:
    ...
    def test_format_education_contains_expected(self, education, expected_contains):
        """Test that formatted education contains expected strings."""
...
# =============================================================================
# PARAMETERIZED TESTS: Profile Validation
# =============================================================================
...
# =============================================================================
# PARAMETERIZED TESTS: Screening Scenarios with Mocked AI
# =============================================================================
...
class TestScreeningScenarios:
    ...
    def test_screening_scenarios(self, profile_fixture, expected_score_range, expected_fit,
        ...
        """Test that different profile types get appropriate scores."""
        profile = request.getfixturevalue(profile_fixture)
        mock_response = {
            "score": expected_score_range[0],
            "fit": expected_fit,
            "summary": f"Test result for {profile_fixture}",
            "why": "Test reasoning",
...
# =============================================================================
# PARAMETERIZED TESTS: Company Quality Recognition
# =============================================================================
...
# =============================================================================
# PARAMETERIZED TESTS: Skills Extraction
# =============================================================================
...
class TestSkillsExtraction:
    ...
    def test_skills_in_prompt(self, skills, must_contain, mock_openai_client,
                               backend_job_description, profile_builder):
        """Test that skills are included in the screening prompt."""
...
# =============================================================================
# PARAMETERIZED TESTS: Rejection Rule Keywords
# =============================================================================
...
class TestRejectionRuleKeywords:
    ...
    @pytest.mark.parametrize("title,should_be_flagged_as", [
        ('VP Engineering', 'overqualified'),
        ('Director of Engineering', 'overqualified'),
        ('CTO', 'overqualified'),
        ('Head of DevOps', 'overqualified'),
        ('Junior Developer', 'junior'),
        ('Intern', 'junior'),
        ('Student Developer', 'junior'),
    ...
    def test_title_appears_in_prompt(self, title, should_be_flagged_as, mock_openai_client,
        ...
        """Test that job titles are included in prompts for AI evaluation."""
...
# =============================================================================
# PARAMETERIZED TESTS: Required Fields in Screening Result
# =============================================================================
...
class TestScreeningResultStructure:
    ...
    def test_result_has_required_fields(self, response_data, expected_fields,
        ...
        """Test that screening results contain required fields."""
